    ...
    return `
        <div class="div-item">
            ...
            <div class="div-item-text">
                ...
                <p class="p-item-address">${item.address}</p>
    ...
    let exampleItemJSON = [
        {
            ...
            address: "Avenida Leovigildo Dias Vieira, 810, Itaguá – Ubatuba, SP",
        ...
        },
        {
            ...
            address: "Avenida José Bento Ribeiro Dantas, Porto da Barra",
